    ...
    <section id="four" class="wrapper style1 special fade-up">
        <div class="container">
            ...
            <form runat="server">
                ...
                <input type="text" id="txtusuario" name="txtusuario" runat="server" placeholder="Usuario" maxlength="30" required="required" />
                <br />
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                      ...
                      <div class="login-register">
                            <a href="Registro.aspx">Registrarse</a> o <a href="Contraseña.aspx">Olvide contraseña</a>
                        </div>
                </div>
