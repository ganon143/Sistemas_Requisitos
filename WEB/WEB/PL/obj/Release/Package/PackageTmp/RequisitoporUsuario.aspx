<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="RequisitoporUsuario.aspx.cs" Inherits="PL.RequisitoporUsuario" %>
                                ...
                                <asp:GridView ID="gdvUsuarios" HorizontalAlign="Center" ShowFooter="true" AutoGenerateColumns="false" runat="server"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-ForeColor="Black">
                                            <ItemTemplate>
                                                <asp:Button ID="btnRoles" CommandName="Requisito" OnClientClick="return openModal();" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" runat="server" Text="Requisito" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                            ...
                            <asp:UpdatePanel runat="server" ID="updpnlModal" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="table-responsive">
                                        ...
                                        <div class="col-lg-1">
                                            <asp:Label Text="Requisito" ID="lblRoles" runat="server" />
                                                ...
                                                <div class="table-responsive" style="overflow-x: auto;">
                                                    <asp:GridView ID="gdvRoles" HorizontalAlign="Center" ShowFooter="true" AutoGenerateColumns="false" runat="server"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="Id_Requisito_Persona" HeaderText="Identificador" />
